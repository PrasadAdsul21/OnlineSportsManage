<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_dashboard.aspx.cs" Inherits="Sport_Management.admin_dashboard" %>
...
<body class="bg-dark text-white">
    <form id="form1" runat="server">
        ...
        <footer id="footer" class="container-fluid " style="height: 5%;">
            ...
            <p class="text-center bg-transparent text-white">&copy; SPORT MANAGEMENT SYSTEM. Design:  Sanket Landge.</p>
