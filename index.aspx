<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Sport_Management.index" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <footer id="foot" class="container-fluid card-body">
            ...
            <p class="mx-auto text-center">&copy; Sanket Landge. &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
        </footer>
